...
<h2 style="color:#7C7C7C;">VOLUNTEER SIGNUP <small>to be verified by placement officer</small></h2><br/>
...
<form method="POST" action="<?php echo 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'];?>" class="form">
	...
	<div class="form-group">
		<label for="admission_no">Username </label>
	...
	<div class="form-group">
		<input type="submit" name="submit" id="submit" class="btn btn-primary" value="Signup as volunteer">
	</div>
</form>
